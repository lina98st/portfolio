...
<h1 className="text-5xl md:text-7xl font-bold leading-tight max-w-4xl">
  ...
  <span className="text-pink">Ships products from idea to deployment.</span>
</h1>
...
<section id="about" className="flex flex-col items-center justify-center py-24 text-center px-6">
  <h2 className="text-4xl font-bold">About me</h2>
  <p className="text-muted text-lg max-w-2xl mt-8">
    I&apos;m Alina, a fullstack developer based in Germany with a strong passion for the frontend. I come from a background in IT business roles, which gives me a broader understanding of how software fits into real business needs.
  </p>
